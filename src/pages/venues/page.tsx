...
export default function VenuesPage() {
  ...
  const venues = [
    ...
    },
    {
      ...
      capacityCategory: 'large',
      matches: 4,
      image: 'https://readdy.ai/api/search-image?query=Empower%20Field%20Denver%20aerial%20view%20with%20Rocky%20Mountains%20backdrop%2C%20NFL%20stadium%20with%20stunning%20mountain%20scenery%2C%20Mile%20High%20City%20sports%20venue%2C%20dramatic%20natural%20landscape%2C%20outdoor%20stadium%20excellence&width=600&height=400&seq=empower1&orientation=landscape',
      opened: 2001,
      surface: 'Natural Grass',
      nearestMetro: 'Stadium/61st-Peña Station',
      metroDistance: 0.3,
      hotelCount: 94,
      avgHotelPrice: 229,
      nearestAirport: 'DEN',
      airportDistance: 35,
      parkingSpaces: 13000,
      description: 'Mile High stadium with breathtaking Rocky Mountain views and the unique thin-air advantage for an unforgettable experience.',
      amenities: ['Mountain views', 'Natural grass', 'Premium seating', 'Altitude advantage', 'Outdoor experience'],
      hotelDeals: 22,
      avgRating: 4.5,
      weatherAdvantage: 'Mile high altitude',
      keyFeatures: ['Mountain views', 'Altitude advantage', 'Natural setting'],
      address: '1701 Bryant St, Denver, CO 80204, United States',
      homeTeams: ['Denver Broncos'],
      notableEvents: ['Super Bowl championships', 'AFC Championship games', 'International soccer matches'],
      seatingInfo: 'Open-air stadium with mountain views, club level seating, and general admission',
      transportation: 'Light rail to Stadium/61st-Peña Station, bus routes, parking available',
      foodAmenities: 'Colorado craft beer, Rocky Mountain cuisine, local specialties, premium dining',
      visitorTips: 'Dress in layers for weather changes, stay hydrated at altitude, enjoy mountain views'
    },
    {
      id: 6,
      name: 'NRG Stadium',
    ...
    },
    {
      ...
      opened: 2020,
      surface: 'Matrix Turf',
      description: 'The newest and most technologically advanced stadium, featuring a translucent canopy design and cutting‑edge amenities.',
      amenities: ['Translucent canopy', '4K video boards', 'Premium clubs', 'Infinity screen', 'Latest technology'],
      hotelDeals: 29,
      avgRating: 4.7,
      weatherAdvantage: 'Climate controlled',
      keyFeatures: ['Newest venue', 'Translucent canopy', 'Hollywood location'],
      address: '1001 Stadium Dr, Inglewood, CA 90301, United States',
      homeTeams: ['Los Angeles Rams', 'Los Angeles Chargers'],
      notableEvents: ['Super Bowl LVI', 'College Football Playoff games', 'International soccer matches'],
      seatingInfo: 'Ultra-modern design with premium seating, club areas, and general admission',
      transportation: 'Metro LAX/Crenshaw Line, shuttle services, rideshare zones, parking available',
      foodAmenities: 'California cuisine, craft cocktails, international food options, premium dining',
      visitorTips: 'Use public transportation, arrive early for security, explore Hollywood nearby'
    },
    {
      id: 9,
      name: 'Lumen Field',
