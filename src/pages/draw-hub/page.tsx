...
export default function DrawHubPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#F5F5F7] dark:bg-[#0A0A0A] font-sans text-slate-900 dark:text-slate-100 overflow-x-hidden selection:bg-[#01b47d]/30">
        
        {/* Hero Section */}
        <div className="relative w-full bg-[#F5F5F7] dark:bg-[#0A0A0A] overflow-hidden">
            ...
            <div className="relative max-w-[1440px] mx-auto pt-32 pb-24 px-6 md:px-12 text-center">
                <motion.div 
                    ...
                    className="inline-flex items-center gap-2 py-2 px-6 rounded-full bg-white/5 border border-slate-200 dark:border-white/10 text-[#01b47d] font-bold text-sm uppercase tracking-widest mb-8 backdrop-blur-md"
                >
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-white dark:bg-white/5 backdrop-blur-md p-6 rounded-2xl border border-slate-200 dark:border-white/10">
        ...
        <main className="max-w-[1440px] mx-auto px-6 md:px-12 -mt-12 relative z-10">
          ...
          <section className="mb-32 relative overflow-hidden rounded-[3rem] bg-[#F5F5F7] dark:bg-[#0A0A0A] text-slate-900 dark:text-white p-12 md:p-24 text-center border border-slate-200 dark:border-white/10">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <div className="bg-white dark:bg-white/10 backdrop-blur-md border border-slate-200 dark:border-white/10 rounded-3xl p-10 md:p-14">
