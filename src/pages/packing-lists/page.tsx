    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white dark:from-navy-900 dark:to-navy-800">
      ...
      <section id="main-content" className="relative py-32 md:py-40 lg:py-48 bg-white dark:bg-navy-900 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-8 right-4 w-16 h-16 xs:top-10 xs:right-6 xs:w-20 xs:h-20 sm:top-16 sm:right-8 sm:w-32 sm:h-32 md:top-20 md:right-10 md:w-40 md:h-40 lg:top-24 lg:right-12 lg:w-48 lg:h-48 xl:w-72 xl:h-72 bg-[#01b47d]/5 dark:bg-[#01b47d]/10 backdrop-blur-3xl rounded-full border border-[#01b47d]/10 dark:border-[#01b47d]/20 animate-float"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            {/* Premium Badge */}
            <div className="inline-flex items-center space-x-3 bg-[#01b47d]/10 backdrop-blur-xl border border-[#01b47d]/20 rounded-full px-8 py-4 mb-8">
              <div className="w-2 h-2 bg-[#01b47d] rounded-full animate-pulse"></div>
              <span className="text-[#01b47d] dark:text-[#01b47d] font-medium text-sm tracking-wide">Premium Packing Solutions</span>
            </div>
            ...
            <h1 className="font-space font-bold text-5xl md:text-7xl lg:text-8xl mb-8 text-navy-900 dark:text-white">
              Pack Like a
              <br />
              <span className="bg-gradient-to-r from-[#01b47d] via-[#01b47d] to-[#01b47d] bg-clip-text text-transparent">
                Pro Traveler
              </span>
            </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="group relative bg-white/60 dark:bg-navy-800/30 backdrop-blur-xl rounded-2xl p-8 border border-slate-200/50 dark:border-navy-600/50 hover:border-[#008f63]/50 dark:hover:border-[#008f63]/30 transition-all duration-300 hover:scale-105">
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-[#01b47d] to-[#01b47d] bg-clip-text text-transparent mb-3">6</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="font-space font-bold text-4xl md:text-5xl text-navy-900 dark:text-white mb-6">
              Curated for Every
              <br />
              <span className="bg-gradient-to-r from-[#01b47d] to-gold-500 bg-clip-text text-transparent">
                Travel Style
              </span>
            </h2>
              ...
              >
                ...
                <div className="relative h-64 overflow-hidden flex-shrink-0">
                  ...
                  <div className="absolute top-6 right-6">
                    <div className="bg-white/90 dark:bg-navy-800/90 text-[#01b47d] dark:text-[#01b47d] px-4 py-2 rounded-full text-sm font-semibold backdrop-blur-sm border border-white/20">
                      {list.items} items
                    </div>
                  </div>
                ...
                <div className="p-8 md:p-7 lg:p-8 flex flex-col flex-grow card-content-equalizer">
                  ...
                  <div className="flex items-center justify-between mb-8 h-6">
                    <div className="flex items-center space-x-4">
                      <div className="flex items-center space-x-2 text-sm text-[#01b47d] dark:text-[#01b47d]">
                  ...
                  <div className="relative">
                    <div className="absolute -inset-1 bg-gradient-to-r from-[#01b47d] to-[#01b47d] rounded-xl blur opacity-20 group-hover:opacity-40 transition duration-300"></div>
                    <button
                      onClick={() => handleListClick(list)}
                      type="button"
                      className="relative w-full inline-flex items-center justify-center font-medium rounded-xl transition-all duration-200 whitespace-nowrap cursor-pointer focus-visible:focus px-6 py-4 text-base bg-[#01b47d] hover:bg-[#008f63] text-white shadow-lg hover:shadow-xl hover:scale-105"
                    >
              ...
              <div className="p-8">
                    ...
                    return (
                      <div
                        ...
                        className={`group relative flex items-start p-6 rounded-2xl border transition-all duration-300 cursor-pointer ${
                          isChecked
                            ? 'bg-[#01b47d]/5 dark:bg-[#008f63]/20 border-[#01b47d]/20 dark:border-[#008f63]/30'
                            : 'bg-white/60 dark:bg-navy-800/30 border-slate-200/30 dark:border-navy-600/30 hover:border-[#008f63]/50 dark:hover:border-[#008f63]/30 hover:bg-white/80 dark:hover:bg-navy-800/50'
                        }`}
                      >
                        {/* Premium Checkbox */}
                        <div className={`flex-shrink-0 w-8 h-8 rounded-xl border-2 flex items-center justify-center mr-5 mt-0.5 transition-all duration-300 ${
                          isChecked
                            ? 'bg-[#01b47d] border-[#01b47d] shadow-lg shadow-[#01b47d]/25'
                            : 'bg-white/80 dark:bg-navy-700/50 border-slate-300 dark:border-navy-500 group-hover:border-[#008f63]'
                        }`}>
                          {isChecked && (
                        ...
                        } bg-gradient-to-r from-[#01b47d]/5 to-transparent`}></div>
                      </div>
                    );
                  })}
                </div>
                ...
                <div className="mt-8 p-6 bg-slate-50/50 dark:bg-navy-800/20 rounded-2xl border border-slate-200/30 dark:border-navy-600/30">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-sm font-bold text-[#01b47d] dark:text-[#01b47d]">
                  ...
                  <div className="w-full bg-slate-200/50 dark:bg-navy-700/50 rounded-full h-2">
                    <div 
                      className="bg-gradient-to-r from-[#01b47d] to-[#01b47d] h-2 rounded-full transition-all duration-500"
                      style={{ 
