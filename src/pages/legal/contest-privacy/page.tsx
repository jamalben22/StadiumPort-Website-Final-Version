...
export default function ContestPrivacyPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Contest Privacy', url: `${import.meta.env.VITE_SITE_URL || 'https://stadiumport.com'}/world-cup-2026-prediction-contest-privacy` }
  ]);
    ...
    <div className="min-h-screen bg-[#F5F5F7] dark:bg-[#0A0A0A] font-inter text-slate-900 dark:text-white selection:bg-indigo-500 selection:text-white transition-colors duration-500">
      <SchemaOrg schema={[
        breadcrumbSchema,
        {
          ...
          "url": `${import.meta.env.VITE_SITE_URL || 'https://stadiumport.com'}/world-cup-2026-prediction-contest-privacy`
        }
      ]} />
      <Header />
