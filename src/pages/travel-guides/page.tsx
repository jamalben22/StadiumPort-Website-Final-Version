...
function TravelGuidesPageOriginal() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-navy-900">
            ...
            <div className="text-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-5xl mx-auto">
                ...
                <div className="group relative text-center">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#01b47d]/5 to-[#01b47d]/5 dark:from-[#008f63]/20 dark:to-[#008f63]/20 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                  <div className="relative p-6 md:p-8 bg-white/80 dark:bg-navy-900/80 backdrop-blur-3xl rounded-3xl border border-white/30 dark:border-navy-800/30 hover:border-[#008f63]/20 dark:hover:border-[#008f63]/20 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-[#01b47d]/10 dark:hover:shadow-[#01b47d]/5">
                    <div className="text-4xl sm:text-5xl md:text-6xl font-space font-bold bg-gradient-to-br from-slate-900 to-slate-700 dark:from-white dark:to-slate-200 bg-clip-text text-transparent mb-3 md:mb-4 group-hover:from-[#01b47d] group-hover:to-[#01b47d] dark:group-hover:from-[#01b47d] dark:group-hover:to-[#01b47d] transition-all duration-700">500+</div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center space-x-3">
                          <div className="w-8 h-8 bg-gradient-to-r from-[#01b47d] to-[#01b47d] rounded-full flex items-center justify-center">
                      ...
                      <div className="flex justify-center">
                        <a
                          ...
                          className="inline-flex items-center justify-center font-medium rounded-xl transition-all duration-200 whitespace-nowrap cursor-pointer px-6 py-3 text-base bg-[#01b47d] hover:bg-[#008f63] text-white shadow-lg hover:shadow-xl hover:scale-105"
                        >
      ...
      <main id="main-content" className="relative bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-navy-900 dark:via-navy-800 dark:to-navy-900 overflow-hidden">
        <div className="absolute inset-0">
        ...
        <div className="relative z-10 pt-16 pb-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white/80 dark:bg-navy-800/80 backdrop-blur-xl border border-white/20 dark:border-navy-700/50 rounded-3xl p-6 md:p-8 shadow-2xl shadow-[#01b47d]/10 mb-20">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 items-center">
                      ...
                      <button
                        ...
                        className={`px-4 py-3 rounded-xl text-sm font-medium transition-all duration-300 cursor-pointer ${
                          selectedCategory === category
                            ? 'bg-gradient-to-r from-[#01b47d] to-[#01b47d] text-white shadow-lg shadow-[#01b47d]/25 scale-105'
                            : 'bg-white/60 dark:bg-navy-700/60 text-slate-600 dark:text-slate-400 hover:bg-[#008f63]/5 dark:hover:bg-[#008f63]/20 border border-slate-200/50 dark:border-navy-600/50 hover:border-[#008f63] dark:hover:border-[#008f63] hover:scale-102'
                        }`}
                      >
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-center p-6 bg-gradient-to-r from-[#01b47d]/5 to-gold-50 dark:from-[#008f63]/20 dark:to-gold-900/20 rounded-xl border border-[#01b47d]/20 dark:border-[#008f63]/50">
                    <div className="text-3xl font-bold text-[#01b47d] mb-2">{filteredArticles.length}</div>
                  ...
                  <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-4 mb-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className="font-semibold text-[#01b47d]">{article.readTime}</div>
                      </div>
                    </div>
                  </div>
                ...
                <button
                  ...
                  className={`flex items-center justify-center w-12 h-12 rounded-xl transition-all duration-300 ${
                    currentPage === 1
                      ...
                      : 'bg-[#01b47d] hover:bg-[#008f63] text-white shadow-lg hover:shadow-xl hover:scale-110 cursor-pointer'
                  }`}
                >
                    ...
                    return (
                      <button
                        ...
                        className={`w-12 h-12 rounded-xl font-semibold transition-all duration-300 cursor-pointer ${
                          currentPage === pageNum
                            ? 'bg-gradient-to-r from-[#01b47d] to-[#01b47d] text-white shadow-lg scale-110'
                            : 'bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-400 hover:bg-[#008f63]/10 dark:hover:bg-[#008f63]/30 hover:text-[#008f63] hover:scale-105'
                        }`}
                      >
                        {pageNum}
                      </button>
            ...
            <div className="inline-block w-full max-w-4xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-navy-800 shadow-xl rounded-2xl">
              ...
              <div className="p-8">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-[#01b47d] text-sm font-medium">Travel Guide</span>
