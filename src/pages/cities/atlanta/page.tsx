...
export default function AtlantaArticlePage() {
  ...
  const currentPath = '/world-cup-2026-host-cities/atlanta-world-cup-2026-guide';
  ...
  useEffect(() => {
    ...
    link.rel = 'preload'
    link.as = 'image'
    link.href = '/images/cities/atlanta-world-cup-2026.webp'
  ...
  const pageUrl = '/world-cup-2026-host-cities/atlanta-world-cup-2026-guide';

  const siteUrl = import.meta.env.VITE_SITE_URL || 'https://stadiumport.com'

  useEffect(() => {
    const entry = getEditorialEntry('city','atlanta')
    setPageMeta({
      title: 'Atlanta – World Cup 2026 Guide',
      description: 'Comprehensive Atlanta travel guide for FIFA World Cup 2026: Mercedes-Benz Stadium details, match schedule, transportation, and where to stay.',
      url: `${siteUrl}${pageUrl}`,
      image: `${siteUrl}/images/cities/atlanta-world-cup-2026.webp`,
      locale: 'en_US',
      publishedTime: entry?.isPublished ? entry.datePublished : '2025-11-16T09:00:00Z',
      modifiedTime: new Date().toISOString(),
      section: entry?.section || 'Host Cities',
      tags: ['World Cup 2026', 'Host Cities', 'Atlanta', 'Mercedes-Benz Stadium', ...(entry?.keywords||[])]
    })
  }, [])
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-50 to-white dark:from-navy-900 dark:to-navy-800">
      <SchemaOrg
        schema={[
          ...
          generateBreadcrumbSchema([
            ...
            { name: 'Atlanta', url: pageUrl }
          ]),
          generateImageObjectSchema(
            '/images/cities/atlanta-world-cup-2026.webp',
            { width: 1600, height: 900, caption: 'Atlanta skyline – World Cup 2026' }
          )
        ]}
      />
      ...
      <section id="main-content" className="editorial-article-premium atlanta-page py-16">
        ...
        <article id="intro" className="editorial-body editorial-dropcap theme-emerald">
          ...
          <div className="mb-8 p-6 bg-slate-50 dark:bg-navy-800 rounded-xl border-l-4 border-emerald-500">
             ...
             <ul className="space-y-1 text-sm text-slate-700 dark:text-slate-300">
               ...
               <li>• Key Event: <strong>Semifinal on July 15</strong></li>
               <li>• Hub: "Capital of the South"</li>
             </ul>
          </div>
