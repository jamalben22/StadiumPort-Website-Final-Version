...
export function PhiladelphiaCityGuide() {
  return (
    <div className="min-h-screen bg-white dark:bg-navy-900">
      ...
      {/* Hero Section - MetLife-style visual, verbatim content only */}
      <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            Philadelphia: Your Ultimate 2026 FIFA World Cup Travel Guide
          </h1>
          <p className="text-slate-300 text-lg max-w-3xl">
            Where American Independence Meets Global Football
          </p>
        </div>
      </div>
      ...
      <main className="p-8 md:p-12 space-y-12">
          ...
          <div className="space-y-8 dark:text-white">
            ...
            <div>
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50 mb-4 flex items-center gap-2">
                <i className="ri-eagle-line text-emerald-400 dark:text-emerald-300"></i>
                An Eagles' Nest Designed for Glory
              </h3>
            ...
            <div>
              ...
              <div className="prose prose-lg max-w-none dark:prose-invert">
                <p>Philadelphia will host six matches between June 14 and July 4, 2026:</p>
        ...
        <div className="bg-white dark:bg-gradient-to-br dark:from-slate-950 dark:to-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
          ...
          <div className="space-y-8 dark:text-white">
            ...
            <div>
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50 mb-4 flex items-center gap-2">
                <i className="ri-roadster-line text-emerald-400 dark:text-emerald-300"></i>
                Getting to Lincoln Financial Field on Match Days
              </h3>
              <div className="prose prose-lg max-w-none dark:prose-invert">
                <p>
        ...
        <div className="bg-white dark:bg-gradient-to-br dark:from-slate-950 dark:to-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert space-y-6 dark:text-white">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">Center City: Maximum Convenience</h3>
              <p>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">Rittenhouse Square: Upscale Elegance</h3>
              <p>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">Old City: Colonial Charm Meets Modern Cool</h3>
              <p>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">University City: Budget-Friendly Near Penn & Drexel</h3>
              <p>
        ...
        <div className="bg-white dark:bg-gradient-to-br dark:from-slate-950 dark:to-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert space-y-6 dark:text-white">
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">Independence National Historical Park: The Birthplace of America</h3>

            {/* Independence Hall */}
            <div className="space-y-4">
              <h4 className="text-lg font-bold text-slate-900 dark:text-slate-50">Independence Hall</h4>
              <p>
            ...
            <div className="space-y-4">
              <h4 className="text-lg font-bold text-slate-900 dark:text-slate-50">The Liberty Bell Center</h4>
              <p>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">Museum of the American Revolution</h3>
              <p>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">Reading Terminal Market: Philadelphia's Culinary Heart</h3>
              <p>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">Philadelphia Museum of Art: The Rocky Steps</h3>
              <p>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">Eastern State Penitentiary: Gothic Prison History</h3>
              <p>
            ...
            {/* Elfreth's Alley */}
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">Elfreth's Alley: America's Oldest Residential Street</h3>
              <p>
        ...
        <div className="bg-white dark:bg-gradient-to-br dark:from-slate-950 dark:to-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-restaurant-2-line text-emerald-400 dark:text-emerald-300 text-4xl"></i>
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert space-y-6 dark:text-white">
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">The Cheesesteak Debate: A Philadelphia Obsession</h3>
            <p>
            ...
            {/* The Classic Order */}
            <div className="space-y-4">
              <h4 className="text-lg font-bold text-slate-900 dark:text-slate-50">The Classic Order</h4>
              <p>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">Top Cheesesteak Destinations</h3>
              <div className="space-y-3">
                <div>
                  <h4 className="text-lg font-bold text-slate-900 dark:text-slate-50">Pat's King of Steaks vs. Geno's Steaks</h4>
                  <p>
                ...
                <div>
                  <h4 className="text-lg font-bold text-slate-900 dark:text-slate-50">Reading Terminal Market</h4>
                  <p>
                ...
                <div>
                  <h4 className="text-lg font-bold text-slate-900 dark:text-slate-50">Steve's Prince of Steaks</h4>
                  <p>
                ...
                <div>
                  <h4 className="text-lg font-bold text-slate-900 dark:text-slate-50">Jim's Steaks</h4>
                  <p>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">Beyond the Cheesesteak: Philly's Diverse Food Scene</h3>
              <div className="space-y-3">
        ...
        <div className="bg-white dark:bg-gradient-to-br dark:from-slate-950 dark:to-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-sun-cloudy-line text-emerald-400 dark:text-emerald-300 text-4xl"></i>
            Weather &amp; What to Pack
          </h2>
          <div className="prose prose-lg max-w-none dark:prose-invert space-y-6 dark:text-white">
            <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">June and July in Philadelphia: Warm with Occasional Rain</h3>
            <p>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">What to Pack</h3>
        ...
        <div className="bg-white dark:bg-gradient-to-br dark:from-slate-950 dark:to-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-shopping-bag-3-line text-emerald-400 dark:text-emerald-300 text-4xl"></i>
            Stadium Policies
          </h2>
          <div className="prose prose-lg max-w-none dark:prose-invert space-y-6 dark:text-white">
            <p>
        ...
        <div className="bg-white dark:bg-gradient-to-br dark:from-slate-950 dark:to-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-global-line text-emerald-400 dark:text-emerald-300 text-4xl"></i>
            Practical Tips for International Visitors
          </h2>
          <div className="prose prose-lg max-w-none dark:prose-invert space-y-6 dark:text-white">
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50">Language &amp; Connectivity</h3>
            <p>
        ...
        <div className="bg-white dark:bg-gradient-to-br dark:from-slate-950 dark:to-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-ticket-2-line text-emerald-400 dark:text-emerald-300 text-4xl"></i>
            Ticket Information &amp; Booking Strategy
          </h2>
          <div className="prose prose-lg max-w-none dark:prose-invert space-y-6 dark:text-white">
            ...
            <div className="space-y-2">
              <h4 className="text-lg font-bold text-slate-900 dark:text-slate-50">July 4th Premium</h4>
              <p>
            ...
            <div className="space-y-2">
              <h4 className="text-lg font-bold text-slate-900 dark:text-slate-50">Hospitality Packages</h4>
              <p>
