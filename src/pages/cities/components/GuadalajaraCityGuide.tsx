  ...
  return (
    <div className="min-h-screen bg-white dark:bg-navy-900">
      ...
      <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            Guadalajara: Where Mariachi, Tequila, and Football Create Magic
          </h1>
        </div>
      </div>
      ...
      <main className="p-8 md:p-12 space-y-12">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-bank-card-line text-emerald-400 dark:text-emerald-300 text-4xl"></i>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-cloud-rain-line text-blue-400 dark:text-sky-300 text-4xl"></i>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-government-line text-blue-400 dark:text-sky-300 text-4xl"></i>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-ancient-gate-line text-blue-400 dark:text-sky-300 text-4xl"></i>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-information-line text-amber-400 dark:text-amber-300 text-4xl"></i>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-shield-check-line text-emerald-400 dark:text-emerald-300 text-4xl"></i>
            Safety
          </h2>
          <div className="prose prose-lg max-w-none dark:prose-invert dark:text-white space-y-6">
            <p>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-water-flash-line text-sky-400 dark:text-sky-300 text-4xl"></i>
            Drinking Water
          </h2>
          <div className="prose prose-lg max-w-none dark:prose-invert dark:text-white space-y-6">
            <p>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-night-clear-line text-fuchsia-400 dark:text-fuchsia-300 text-4xl"></i>
            Nightlife
          </h2>
          <div className="prose prose-lg max-w-none dark:prose-invert dark:text-white space-y-6">
            <p>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-8 flex items-center gap-3">
            <i className="ri-trophy-line text-yellow-400 dark:text-yellow-300 text-4xl"></i>
