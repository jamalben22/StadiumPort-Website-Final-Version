...
export const PrizeBento = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
      ...
      <div className="relative overflow-hidden rounded-[32px] bg-[#111] border border-white/10 p-6 group hover:border-[#FBBF24]/30 transition-colors">
        {/* Background Gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#FBBF24]/5 to-transparent opacity-50" />
        ...
        <div className="relative z-10 flex flex-col h-full">
          <div className="flex items-start justify-between mb-6">
            ...
            <span className="px-3 py-1 rounded-full bg-[#FBBF24]/10 border border-[#FBBF24]/20 text-[#FBBF24] text-[10px] font-bold uppercase tracking-widest">
              1st Place
            </span>
          </div>
          ...
          <div className="mt-auto space-y-3">
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/5">
              ...
              <span className="text-sm text-white/80 font-['Rajdhani']">Original WC26 Jersey</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative overflow-hidden rounded-[32px] bg-[#111] border border-white/10 p-6 group hover:border-white/20 transition-colors">
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="mt-auto space-y-3">
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/5">
              ...
              <span className="text-sm text-white/80 font-['Rajdhani']">Official Match Ball</span>
            </div>
          </div>
        </div>
      </div>
