...
export function DarkModeToggle() {
  ...
  return (
    <button
      ...
      className="group relative w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 border border-slate-200/60 dark:border-slate-800/60 bg-white/70 dark:bg-slate-900/40 backdrop-blur-xl hover:bg-white/90 dark:hover:bg-slate-900/60 shadow-md hover:shadow-lg"
