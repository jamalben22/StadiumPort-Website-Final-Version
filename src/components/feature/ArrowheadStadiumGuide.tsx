        ...
        <div className="animate-fade-in">
          ...
          <div className="bg-gradient-to-r from-slate-900 to-slate-800 p-8 md:p-12 border-b border-slate-700/50">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-3 h-3 bg-gradient-to-r from-red-400 to-gold-400 rounded-full animate-pulse"></div>
              <span className="text-red-400 font-medium text-sm uppercase tracking-wider">FIFA World Cup 2026</span>
            </div>
            ...
            <div className="flex items-center gap-6 mb-6">
              <div className="flex items-center gap-2 text-slate-300">
                <i className="ri-group-line text-xl text-red-400"></i>
              ...
              <div className="flex items-center gap-2 text-slate-300">
                <i className="ri-volume-up-line text-xl text-red-400"></i>
          ...
          <div className="p-8 md:p-12 space-y-12">
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              <div className="bg-gradient-to-r from-red-500/10 to-gold-500/10 border border-red-500/20 rounded-2xl p-8 mb-8">
                <h2 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
                  <i className="ri-volume-up-line text-red-400 text-4xl"></i>
            ...
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
              <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                <i className="ri-building-line text-red-400 text-4xl"></i>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                    <i className="ri-building-2-line text-red-400 text-xl"></i>
                    <div>
                      <span className="text-slate-400 text-sm">Official Name</span>
                      <p className="text-white font-semibold">GEHA Field at Arrowhead Stadium</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                    <i className="ri-map-pin-line text-red-400 text-xl"></i>
                    <div>
                      <span className="text-slate-400 text-sm">Location</span>
                      <p className="text-white font-semibold">Kansas City, Missouri (Truman Sports Complex)</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                    <i className="ri-group-line text-red-400 text-xl"></i>
                    <div>
                      <span className="text-slate-400 text-sm">Capacity</span>
                      <p className="text-white font-semibold">76,416 (World Cup configuration)</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                    <i className="ri-calendar-line text-red-400 text-xl"></i>
                    <div>
                      <span className="text-slate-400 text-sm">Opened</span>
                      <p className="text-white font-semibold">August 12, 1972</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                    <i className="ri-grass-line text-red-400 text-xl"></i>
                    <div>
                      <span className="text-slate-400 text-sm">Playing Surface</span>
                      <p className="text-white font-semibold">Natural Grass</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                    <i className="ri-home-line text-red-400 text-xl"></i>
                    <div>
                      <span className="text-slate-400 text-sm">Home Team</span>
                      <p className="text-white font-semibold">Kansas City Chiefs</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                    <i className="ri-volume-up-line text-red-400 text-xl"></i>
                    <div>
                      <span className="text-slate-400 text-sm">Noise Record</span>
                      <p className="text-white font-semibold">142.2 decibels (2014)</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                    <i className="ri-car-line text-red-400 text-xl"></i>
                    <div>
                      <span className="text-slate-400 text-sm">Parking</span>
                      <p className="text-white font-semibold">27,000+ spaces</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="grid md:grid-cols-2 gap-4 text-slate-300">
                  <div className="flex items-center gap-2">
                    <i className="ri-checkbox-circle-line text-red-400"></i>
            ...
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
              <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                <i className="ri-building-4-line text-red-400 text-4xl"></i>
            ...
            <div className="bg-gradient-to-br from-red-500/10 to-gold-500/10 border border-red-500/20 rounded-2xl p-8">
              <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                <i className="ri-football-line text-red-400 text-4xl"></i>
                What Matches to Expect
              </h2>
            ...
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
              <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                <i className="ri-map-2-line text-red-400 text-4xl"></i>
                Getting to the Stadium
              </h2>
              
              {/* By Public Transportation */}
              <div className="mb-8 p-6 bg-gradient-to-r from-red-500/10 to-gold-500/10 border border-red-500/20 rounded-xl">
                <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                  <i className="ri-bus-line text-red-400 text-2xl"></i>
                  By Public Transportation
                </h3>
              ...
              {/* By Rideshare/Taxi */}
              <div className="mb-8 p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
                <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                  <i className="ri-taxi-line text-red-400 text-2xl"></i>
                  By Rideshare/Taxi
                </h3>
                <p className="text-slate-300 leading-relaxed mb-4">
              ...
              <div className="mb-8 p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
                <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                  <i className="ri-bike-line text-red-400 text-2xl"></i>
                  By Bike
                </h3>
                <p className="text-slate-300 leading-relaxed mb-4">
              ...
              <div className="p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
                <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                  <i className="ri-plane-line text-red-400 text-2xl"></i>
            ...
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
              <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                <i className="ri-hotel-line text-red-400 text-4xl"></i>
                Where to Stay
              </h2>
              ...
              <div className="mb-8 p-6 bg-gradient-to-r from-red-500/10 to-gold-500/10 border border-red-500/20 rounded-xl">
                <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                  <i className="ri-building-line text-red-400 text-2xl"></i>
                ...
                <div className="space-y-4">
                  <div className="bg-slate-800/50 p-4 rounded-lg">
                    ...
                    <p className="text-slate-300 text-sm">Autograph Collection hotel in the Power & Light District. Rooftop bar, upscale dining, walking distance to entertainment. $280-400/night during World Cup.</p>
                  </div>
                  ...
                  <div className="bg-slate-800/50 p-4 rounded-lg">
                    ...
                    <p className="text-slate-300 text-sm">1931 Art Deco landmark with modern amenities. Downtown location, elegant rooms, historic character. $220-320/night.</p>
                  </div>
                  ...
                  <div className="bg-slate-800/50 p-4 rounded-lg">
                    ...
                    <p className="text-slate-300 text-sm">Reliable chain hotel in the heart of downtown. Connected to convention center, multiple dining options. $180-280/night.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8 p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
                <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                  <i className="ri-shopping-cart-line text-red-400 text-2xl"></i>
                ...
                <div className="space-y-4">
                  <div className="bg-slate-800/50 p-4 rounded-lg">
                    <h4 className="font-semibold text-white mb-2">Sheraton Crown Center</h4>
                    <p className="text-slate-300 text-sm">Large hotel connected to shopping and dining. Indoor walkways to Union Station. $160-240/night.</p>
                  </div>
                  
                  <div className="bg-slate-800/50 p-4 rounded-lg">
                    <h4 className="font-semibold text-white mb-2">Westin Crown Center</h4>
                    <p className="text-slate-300 text-sm">Upscale option with excellent amenities. Connected to Crown Center shops and restaurants. $200-300/night.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8 p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
                <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                  <i className="ri-store-line text-red-400 text-2xl"></i>
                ...
                <div className="space-y-4">
                  <div className="bg-slate-800/50 p-4 rounded-lg">
                    <h4 className="font-semibold text-white mb-2">The Raphael Hotel</h4>
                    <p className="text-slate-300 text-sm">Boutique European-style hotel on the Plaza. Elegant rooms, fine dining, walkable to shops. $190-290/night.</p>
                  </div>
                  
                  <div className="bg-slate-800/50 p-4 rounded-lg">
                    <h4 className="font-semibold text-white mb-2">InterContinental Kansas City</h4>
                    <p className="text-slate-300 text-sm">Luxury hotel at the Plaza. Rooftop restaurant, spa services, premium amenities. $250-380/night.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
                <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                  <i className="ri-map-pin-line text-red-400 text-2xl"></i>
                ...
                <div className="space-y-4">
                  <div className="bg-slate-800/50 p-4 rounded-lg">
                    <h4 className="font-semibold text-white mb-2">Drury Inn & Suites Stadium</h4>
                    <p className="text-slate-300 text-sm">Closest hotel to Arrowhead Stadium. Free breakfast, evening snacks, indoor pool. $120-180/night.</p>
                  </div>
                  
                  <div className="bg-slate-800/50 p-4 rounded-lg">
                    <h4 className="font-semibold text-white mb-2">Holiday Inn Express Independence</h4>
                    <p className="text-slate-300 text-sm">15 minutes from stadium. Basic amenities, free breakfast, reliable chain quality. $100-150/night.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
              <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                <i className="ri-lightbulb-line text-gold-400 text-4xl"></i>
                Matchday Tips & Insider Advice
              </h2>

              {/* What to Bring */}
              <div className="mb-6 p-6 bg-gradient-to-r from-red-500/10 to-gold-500/10 border border-red-500/20 rounded-xl">
                <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
                  <i className="ri-suitcase-line text-red-400"></i>
                  What to Bring
                </h3>
                <ul className="text-slate-300 space-y-2">
                  <li className="flex items-start gap-2">
                    <i className="ri-sun-line text-gold-400 mt-1"></i>
                    <span>Sunscreen and hat (summer sun can be intense, limited shade in upper sections)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <i className="ri-drop-line text-blue-400 mt-1"></i>
                    <span>Water bottle (empty, to fill inside) - Kansas City summers are hot and humid</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <i className="ri-shirt-line text-green-400 mt-1"></i>
                    <span>Layers for evening matches (temperatures can drop significantly after sunset)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <i className="ri-id-card-line text-orange-400 mt-1"></i>
              ...
              {/* Food & Drink */}
              <div className="mb-6 p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
                <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
              ...
              <div className="mb-6 p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
                <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
                  <i className="ri-door-open-line text-blue-400"></i>
              ...
              <div className="p-6 bg-red-500/10 border border-red-500/20 rounded-xl">
                <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
                  <i className="ri-car-line text-red-400"></i>
                  Post-Match Transport
                </h3>
                <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
              <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                <i className="ri-heart-line text-red-400 text-4xl"></i>
                Atmosphere & Culture
              </h2>
            ...
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
              <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                <i className="ri-compass-line text-red-400 text-4xl"></i>
                Things to Do Nearby
              </h2>
              ...
              <div className="mb-8 p-6 bg-gradient-to-r from-red-500/10 to-gold-500/10 border border-red-500/20 rounded-xl">
                <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                  <i className="ri-restaurant-line text-red-400 text-2xl"></i>
                  Pre-Match BBQ Pilgrimage
                </h3>
                <div className="bg-slate-800/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">LC's Bar-B-Q (5800 Blue Parkway)</h4>
                  <p className="text-slate-300 text-sm">Five minutes from the stadium, perfect for authentic KC BBQ before the match. Counter-service, no-frills, legendary ribs and burnt ends.</p>
                </div>
              </div>
              ...
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                  <i className="ri-map-2-line text-red-400 text-2xl"></i>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-600/30">
                    <h4 className="font-semibold text-white mb-3 flex items-center gap-2">
                      <i className="ri-trophy-line text-gold-400"></i>
                  ...
                  <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-600/30">
                    <h4 className="font-semibold text-white mb-3 flex items-center gap-2">
                      <i className="ri-goblet-line text-gold-400"></i>
                  ...
                  <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-600/30">
                    <h4 className="font-semibold text-white mb-3 flex items-center gap-2">
                      <i className="ri-shopping-bag-line text-gold-400"></i>
                      Country Club Plaza
                    </h4>
                    <p className="text-slate-300 text-sm leading-relaxed">
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-600/30">
                    <h4 className="font-semibold text-white mb-3">Power and Light District</h4>
                    <p className="text-slate-300 leading-relaxed">
                  ...
                  <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-600/30">
                    <h4 className="font-semibold text-white mb-3">18th & Vine Jazz District</h4>
                    <p className="text-slate-300 leading-relaxed">
              ...
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                  <i className="ri-fire-line text-red-400 text-2xl"></i>
                  Essential Kansas City BBQ Experiences
                </h3>
                
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-600/30">
                    <h4 className="font-semibold text-white mb-3">Arthur Bryant's (1727 Brooklyn Ave)</h4>
                    <p className="text-slate-300 text-sm leading-relaxed">
                  ...
                  <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-600/30">
                    <h4 className="font-semibold text-white mb-3">Gates Bar-B-Q (Multiple locations)</h4>
                    <p className="text-slate-300 text-sm leading-relaxed">
                  ...
                  <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-600/30">
                    <h4 className="font-semibold text-white mb-3">Joe's Kansas City Bar-B-Que (47th & Mission Road, KS)</h4>
                    <p className="text-slate-300 text-sm leading-relaxed">
                  ...
                  <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-600/30">
                    <h4 className="font-semibold text-white mb-3">Q39 (Multiple locations)</h4>
                    <p className="text-slate-300 text-sm leading-relaxed">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                  <i className="ri-music-line text-red-400 text-2xl"></i>
                  Post-Match Celebrations
                </h3>
                
                <div className="space-y-4">
                  <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-600/30">
                    <h4 className="font-semibold text-white mb-3">Westport Entertainment District</h4>
                    <p className="text-slate-300 leading-relaxed">
                  ...
                  <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-600/30">
                    <h4 className="font-semibold text-white mb-3">Crossroads Arts District</h4>
                    <p className="text-slate-300 leading-relaxed">
              ...
              <div className="prose prose-invert prose-lg max-w-none">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  <div className="bg-red-500/10 border border-red-500/20 p-6 rounded-xl">
                    <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
                      <i className="ri-thumb-up-line text-red-400"></i>
