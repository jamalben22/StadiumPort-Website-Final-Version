        ...
        <div className="animate-fade-in">
          ...
          <div className="bg-gradient-to-r from-slate-900 to-slate-800 p-8 md:p-12 border-b border-slate-700/50">
            ...
            <div className="flex items-center gap-6 mb-6">
              ...
              <div className="flex items-center gap-2 text-slate-300">
                <i className="ri-trophy-line text-xl text-gold-400"></i>
          ...
          <div className="p-8 md:p-12 space-y-12">
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              <div className="bg-gradient-to-r from-blue-500/10 to-emerald-500/10 border border-blue-500/20 rounded-2xl p-8 mb-8">
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
            <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
              <i className="ri-building-line text-blue-400 text-4xl"></i>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold">MetLife Stadium (FIFA designation: New York New Jersey Stadium)</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold">East Rutherford, New Jersey (8 miles/13 km west of Manhattan)</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold">April 2010</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold">82,500 (World Cup configuration: approximately 82,500)</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold">New York Giants and New York Jets (NFL)</p>
                  </div>
                </div>
                
                <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                  <i className="ri-pencil-ruler-2-line text-emerald-400 text-xl"></i>
                  <div>
                    <span className="text-slate-400 text-sm">Architects</span>
                    <p className="text-white font-semibold">360 Architecture, EwingCole, Rockwell Group, Bruce Mau Design</p>
                  </div>
                </div>
                
                <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                  <i className="ri-grass-line text-emerald-400 text-xl"></i>
                  <div>
                    <span className="text-slate-400 text-sm">Surface</span>
                    <p className="text-white font-semibold">FieldTurf (artificial); natural grass to be installed for World Cup 2026</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-xl">
                  ...
                  <div>
                    <span className="text-slate-400 text-sm">Construction Cost</span>
                    <p className="text-white font-semibold">$1.6 billion (2010)</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
            <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
              <i className="ri-building-4-line text-blue-400 text-4xl"></i>
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
            <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
              <i className="ri-map-2-line text-blue-400 text-4xl"></i>
              Getting to the Stadium
            </h2>
            
            {/* By Train */}
            <div className="mb-8 p-6 bg-gradient-to-r from-emerald-500/10 to-blue-500/10 border border-emerald-500/20 rounded-xl">
              <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                <i className="ri-train-line text-emerald-400 text-2xl"></i>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-r from-gold-500/10 to-amber-500/10 border border-gold-500/20 p-4 rounded-lg">
                  <h4 className="text-lg font-semibold text-white mb-2 flex items-center gap-2">
                    <i className="ri-lightbulb-line text-gold-400"></i>
                    Tips:
                  </h4>
            ...
            <div className="mb-8 p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
              <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                <i className="ri-bus-line text-blue-400 text-2xl"></i>
                By Bus
              </h3>
              <p className="text-slate-300 leading-relaxed">
            ...
            <div className="mb-8 p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
              <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                <i className="ri-car-line text-blue-400 text-2xl"></i>
                By Car
              </h3>
              <p className="text-slate-300 leading-relaxed">
            ...
            <div className="p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
              <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                <i className="ri-plane-line text-blue-400 text-2xl"></i>
                From NYC Airports:
              </h3>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-slate-800/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Newark Liberty (EWR)</h4>
                  <p className="text-slate-300 text-sm">15 miles, 25-35 minutes by car or rideshare ($40-60); NJ Transit train to Penn Station available</p>
                </div>
                <div className="bg-slate-800/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">LaGuardia (LGA)</h4>
                  <p className="text-slate-300 text-sm">18 miles, 35-50 minutes depending on traffic</p>
                </div>
                <div className="bg-slate-800/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">JFK</h4>
                  <p className="text-slate-300 text-sm">28 miles, 45-70 minutes in moderate traffic</p>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
            <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
              <i className="ri-hotel-line text-blue-400 text-4xl"></i>
              Where to Stay
            </h2>
            ...
            <div className="mb-8 p-6 bg-gradient-to-r from-emerald-500/10 to-blue-500/10 border border-emerald-500/20 rounded-xl">
              <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                <i className="ri-map-pin-line text-emerald-400 text-2xl"></i>
              ...
              <div className="space-y-4">
                <div className="bg-slate-800/50 p-4 rounded-lg">
                  ...
                  <p className="text-slate-300">Super 8 by Wyndham Meadowlands ($80-120/night), Extended Stay America Meadowlands</p>
                </div>
                ...
                <div className="bg-slate-800/50 p-4 rounded-lg">
                  ...
                  <p className="text-slate-300">Hampton Inn Carlstadt-At The Meadowlands, Residence Inn by Marriott East Rutherford Meadowlands ($130-200/night)—many offer free parking and shuttle services</p>
                </div>
                
                <div className="bg-slate-800/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2 flex items-center gap-2">
                    <i className="ri-vip-crown-line text-gold-400"></i>
                    Upscale:
                  </h4>
                  <p className="text-slate-300">Renaissance Meadowlands Hotel ($180-280/night), featuring modern amenities and proximity to American Dream mall</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8 p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
              <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                <i className="ri-train-line text-blue-400 text-2xl"></i>
            ...
            <div className="mb-8 p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <i className="ri-money-dollar-circle-line text-green-400 mt-1"></i>
                  <div>
                    <span className="text-white font-semibold">Budget:</span>
                    <span className="text-slate-300 ml-2">Hostels in Midtown/Hell's Kitchen ($50-80/night for dorms)</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <i className="ri-star-line text-blue-400 mt-1"></i>
                  <div>
                    <span className="text-white font-semibold">Mid-Range:</span>
                    <span className="text-slate-300 ml-2">Countless chain hotels near Penn Station and Times Square ($200-400/night during World Cup)</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <i className="ri-vip-crown-line text-gold-400 mt-1"></i>
                  <div>
                    <span className="text-white font-semibold">Luxury:</span>
                    <span className="text-slate-300 ml-2">Midtown five-stars like The St. Regis or Peninsula ($500-1,200/night)</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Booking Tip */}
            <div className="p-6 bg-gradient-to-r from-gold-500/10 to-amber-500/10 border border-gold-500/20 rounded-xl">
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
            <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
              <i className="ri-calendar-check-line text-emerald-400 text-4xl"></i>
              Matchday Tips & Insider Advice
            </h2>

            {/* Arrive Early */}
            <div className="mb-6 p-6 bg-gradient-to-r from-emerald-500/10 to-blue-500/10 border border-emerald-500/20 rounded-xl">
            ...
            {/* Bag Policy */}
            <div className="mb-6 p-6 bg-gradient-to-r from-red-500/10 to-orange-500/10 border border-red-500/20 rounded-xl">
              <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-green-500/10 border border-green-500/20 p-4 rounded-lg">
                  <h4 className="text-green-400 font-semibold mb-2">✅ Allowed:</h4>
            ...
            <div className="mb-6 p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
              <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
                <i className="ri-suitcase-line text-blue-400"></i>
                What to Bring
              </h3>
              <div className="grid md:grid-cols-2 gap-4">
                <ul className="text-slate-300 space-y-2">
                  ...
                  <li className="flex items-center gap-2">
                    <i className="ri-restaurant-line text-emerald-400"></i>
                ...
                <ul className="text-slate-300 space-y-2">
                  <li className="flex items-center gap-2">
                    <i className="ri-shirt-line text-purple-400"></i>
                    Light jacket for evening matches—New Jersey summer nights can cool down
                  </li>
                  <li className="flex items-center gap-2">
                    <i className="ri-battery-charge-line text-green-400"></i>
                    Power bank for your phone (long days drain batteries)
                  </li>
                  <li className="flex items-center gap-2">
                    <i className="ri-id-card-line text-orange-400"></i>
            ...
            <div className="p-6 bg-gradient-to-r from-amber-500/10 to-orange-500/10 border border-amber-500/20 rounded-xl">
              <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
                <i className="ri-logout-box-line text-amber-400"></i>
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-2xl p-8 border border-slate-600/30">
            <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
              <i className="ri-compass-3-line text-purple-400 text-4xl"></i>
              Things to Do Nearby
            </h2>
            ...
            <div className="mb-8 p-6 bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-xl">
              <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                <i className="ri-shopping-cart-line text-purple-400 text-2xl"></i>
            ...
            <div className="mb-8 p-6 bg-slate-800/30 rounded-xl border border-slate-600/30">
              <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                <i className="ri-restaurant-line text-orange-400 text-2xl"></i>
              ...
              <div className="space-y-4">
                <div className="bg-slate-800/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Redds Restaurant & Biergarten (0.5 miles)</h4>
                  <p className="text-slate-300 text-sm">Classic pub grub, shuttle service to/from stadium ($50 including parking), outdoor seating</p>
                </div>
                <div className="bg-slate-800/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Marcus Live! Bar & Grille (American Dream)</h4>
                  <p className="text-slate-300 text-sm">Sports bar atmosphere with 35+ TVs, extensive menu</p>
                </div>
                <div className="bg-slate-800/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Gianna's (Carlstadt, 2 miles)</h4>
                  <p className="text-slate-300 text-sm">Old-school Italian with massive portions—penne vodka, veal piccata</p>
                </div>
                <div className="bg-slate-800/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Segovia Meson (nearby)</h4>
                  <p className="text-slate-300 text-sm">Spanish tapas and authentic cuisine</p>
                </div>
              </div>
            ...
            <div className="p-6 bg-gradient-to-r from-gold-500/10 to-amber-500/10 border border-gold-500/20 rounded-xl">
              <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                <i className="ri-party-popper-line text-gold-400 text-2xl"></i>
                Post-Match Celebrations
              </h3>
              <p className="text-slate-300 leading-relaxed">
          ...
          {/* Final Verdict */}
          <div className="bg-gradient-to-br from-gold-500/10 to-amber-500/10 border border-gold-500/20 rounded-2xl p-8">
            <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
              <i className="ri-medal-line text-gold-400 text-4xl"></i>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-emerald-500/10 border border-emerald-500/20 p-6 rounded-xl">
                  <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
                    <i className="ri-thumb-up-line text-emerald-400"></i>
                    Perfect for:
                  </h3>
                  <p className="text-slate-300">
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 border border-red-500/20 p-6 rounded-xl">
                <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
                  <i className="ri-alarm-line text-red-400"></i>
                  Book Early:
                </h3>
                <p className="text-slate-300">
