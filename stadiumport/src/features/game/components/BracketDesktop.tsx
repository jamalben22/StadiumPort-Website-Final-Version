...
export const BracketDesktop = React.memo(({
  ...
  return (
    <div className="w-full relative bg-transparent py-20 z-10">
          ...
          <div className="relative w-full h-12 flex">
            {ROUNDS.map((roundId, rIndex) => {
              ...
              return (
                ...
                >
                  <div
                    className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full backdrop-blur-md bg-[#0A0A0C]/40 border border-white/10 shadow-[0_2px_8px_rgba(0,0,0,0.2)]"
                  >
                    <span
                      className="text-[11px] font-['Rajdhani'] font-bold uppercase tracking-[0.2em] text-white"
                    >
                    ...
                    return (
                      ...
                      >
                        <div className="w-full flex items-center justify-center mb-1">
                          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full backdrop-blur-md border border-white/10 bg-[#0A0A0C]/40 text-[10px] font-['Rajdhani'] font-bold uppercase tracking-widest text-slate-400">Third Place</span>
                        </div>
                        ...
                        >
                          {team1 && team2 ? (
                            ...
                            <div className="relative flex w-full rounded-lg overflow-hidden bg-[#0A0A0C]/40 backdrop-blur-xl ring-1 ring-white/10 shadow-md h-full items-center justify-between px-3">
                              <div className="flex items-center gap-3">
                                <div className="w-8 h-6 rounded bg-white/5 flex items-center justify-center border border-white/5"><span className="text-[8px] font-bold text-slate-400 font-['Rajdhani']">TBD</span></div>
                                <span className="font-['Teko'] text-lg uppercase text-slate-500">Locked until Semi-Finals</span>
                              </div>
                              <span className="text-[10px] font-bold text-slate-500 font-['Rajdhani']">Third Place</span>
                            </div>
                          )}
                        </div>
