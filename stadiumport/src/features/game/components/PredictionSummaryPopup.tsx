  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-[95vw] md:max-w-5xl bg-[#0A0A0C] border border-white/10 rounded-3xl shadow-2xl overflow-hidden flex flex-col my-6 md:my-0"
      >
        {/* Header */}
        <div className="flex-none px-4 sm:px-6 md:px-8 py-4 sm:py-5 md:py-6 border-b border-white/5 bg-gradient-to-r from-white/5 to-transparent flex justify-between items-center">
          <div>
            ...
            <p className="text-slate-400 text-xs sm:text-sm font-['Rajdhani'] font-bold uppercase tracking-widest">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-center gap-6 md:gap-16">
                  ...
                  <div className="flex flex-col items-center opacity-80 scale-90">
                    <div className="relative w-14 h-14 sm:w-16 sm:h-16 md:w-24 md:h-24 mb-3 sm:mb-4 shadow-lg rounded-full overflow-hidden border-2 border-white/10 grayscale-[50%]">
                      {runnerUp?.flagUrl && (
                        <Image 
