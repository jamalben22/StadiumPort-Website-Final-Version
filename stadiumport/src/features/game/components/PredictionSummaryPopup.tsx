  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-[95vw] md:max-w-5xl bg-white border border-black/10 rounded-3xl shadow-2xl overflow-hidden flex flex-col my-6 md:my-0"
      >
        {/* Header */}
        <div className="flex-none px-4 sm:px-6 md:px-8 py-4 sm:py-5 md:py-6 border-b border-black/5 bg-gradient-to-r from-black/5 to-transparent flex justify-between items-center">
          <div>
            <h2 className="text-xl sm:text-2xl font-['Teko'] font-bold uppercase tracking-wide text-slate-900">
              Prediction Summary
            </h2>
            <p className="text-slate-900/60 text-xs sm:text-sm font-['Rajdhani'] font-bold uppercase tracking-widest">
          ...
          {onCancel && (
            <button 
              onClick={onCancel}
              className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-slate-900/40 hover:text-slate-900 transition-colors"
            >
              Edit Predictions
            </button>
          )}
        ...
        <div className="flex-1 p-4 sm:p-6 md:p-8 custom-scrollbar overflow-visible">
          <div className="space-y-6 sm:space-y-8 md:space-y-10">
            ...
            {/* 1. The Final (Hero) */}
            <div className="relative bg-gradient-to-b from-black/5 to-transparent rounded-2xl p-5 sm:p-6 md:p-8 border border-black/10 text-center overflow-hidden">
              {/* Background Glow */}
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-center gap-6 md:gap-16">
                  ...
                  <div className="flex flex-col items-center opacity-50">
                    <span className="text-2xl sm:text-3xl md:text-4xl font-['Teko'] text-slate-900/20 font-bold">VS</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center opacity-80 scale-90">
                    ...
                    <span className="text-[10px] sm:text-xs font-['Rajdhani'] font-bold uppercase tracking-widest text-slate-900/30 mt-1">
                      Runner-Up
                    </span>
                  </div>
                </div>
            ...
            <div>
              <h4 className="text-base sm:text-lg font-['Rajdhani'] font-bold uppercase tracking-widest text-slate-900/60 mb-3 sm:mb-4 border-b border-black/10 pb-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-4">
                {sortedGroupIds.map(groupId => {
                  ...
                  return (
                    <div key={groupId} className="bg-slate-100 rounded-xl p-2 sm:p-3 border border-black/5 flex items-center justify-between">
                      <span className="text-[10px] sm:text-xs font-bold text-slate-900/30 w-4">
                        {groupId}
                      </span>
