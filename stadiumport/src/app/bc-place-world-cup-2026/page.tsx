...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Complete guide to BC Place for World Cup 2026. Seating charts, capacity, parking & local transport tips for Vancouver.',
    type: 'article',
    url: 'https://stadiumport.com/bc-place-world-cup-2026',
...
export default function Page() {
  const breadcrumbLd = generateBreadcrumbSchema([
    ...
    { name: 'BC Place Guide', item: '/bc-place-world-cup-2026' }
  ]);

  const stadium = WORLD_CUP_STADIUMS.find(s => s.id === 'bc-place');
