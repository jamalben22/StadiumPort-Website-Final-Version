...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://stadiumport.com/world-cup-2026-border-crossing-guide',
  },
  openGraph: {
    ...
    url: 'https://stadiumport.com/world-cup-2026-border-crossing-guide',
    siteName: 'stadiumport',
    locale: 'en_US',
    type: 'article',
    images: [
      {
        url: '/images/safety-guide/Border Crossing Guide USA, Canada & Mexico.webp',
        width: 1200,
        height: 630,
        alt: 'World Cup 2026 Border Crossing Guide',
      },
    ],
  },
  twitter: {
    ...
    title: 'Border Crossing Guide: USA, Canada & Mexico 2026',
    description: 'The definitive border crossing guide for World Cup 2026. Navigate USA, Canada, and Mexico borders smoothly.',
    images: ['/images/safety-guide/Border Crossing Guide USA, Canada & Mexico.webp'],
  },
};
...
export default async function BorderCrossingPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Border Crossing Guide', item: '/world-cup-2026-border-crossing-guide' }
  ]);
