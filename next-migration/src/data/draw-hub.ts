...
export const STADIUM_LINKS: LinkItem[] = [
  ...
  { name: 'BC Place', url: '/world-cup-2026-stadiums/bc-place-guide' },
...
export const CITY_LINKS: LinkItem[] = [
  { name: 'New York/New Jersey', url: '/world-cup-2026-host-cities/new-york-city-guide' },
  { name: 'Atlanta', url: '/world-cup-2026-host-cities/atlanta-city-guide' },
  { name: 'Boston', url: '/world-cup-2026-host-cities/boston-city-guide' },
  { name: 'Dallas', url: '/world-cup-2026-host-cities/dallas-city-guide' },
  { name: 'Guadalajara', url: '/world-cup-2026-host-cities/guadalajara-city-guide' },
  { name: 'Houston', url: '/world-cup-2026-host-cities/houston-city-guide' },
  { name: 'Kansas City', url: '/world-cup-2026-host-cities/kansas-city-city-guide' },
  { name: 'Los Angeles', url: '/world-cup-2026-host-cities/los-angeles-city-guide' },
  { name: 'Mexico City', url: '/world-cup-2026-host-cities/mexico-city-city-guide' },
  { name: 'Miami', url: '/world-cup-2026-host-cities/miami-city-guide' },
  { name: 'Monterrey', url: '/world-cup-2026-host-cities/monterrey-city-guide' },
  { name: 'Philadelphia', url: '/world-cup-2026-host-cities/philadelphia-city-guide' },
  { name: 'San Francisco Bay Area', url: '/world-cup-2026-host-cities/san-francisco-city-guide' },
  { name: 'Seattle', url: '/world-cup-2026-host-cities/seattle-city-guide' },
  { name: 'Toronto', url: '/world-cup-2026-host-cities/toronto-city-guide' },
  { name: 'Vancouver', url: '/world-cup-2026-host-cities/vancouver-city-guide' }
];
