...
import { ShieldCheck, Globe, Gem, Lock } from 'lucide-react';
  ...
  return (
    <section className="relative py-32 md:py-48 border-t border-slate-100 dark:border-white/5 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-20 md:gap-16 mb-40 md:mb-64">
          {trustIndicators.map((item, idx) => (
            ...
            >
              ...
              <h3 className="font-space font-extrabold text-2xl md:text-3xl text-slate-900 dark:text-white mb-4 tracking-tight leading-tight">
                {item.text}
              </h3>
              <div className="w-8 h-[2px] bg-primary mb-6 scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
