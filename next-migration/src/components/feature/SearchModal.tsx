...
const SEARCH_DATA: SearchResult[] = [
  ...
  { id: 'c1', type: 'city', title: 'New York / New Jersey', description: 'MetLife Stadium - Final Host', path: '/world-cup-2026-host-cities/new-york-city-guide', icon: MapPin },
  { id: 'c2', type: 'city', title: 'Los Angeles', description: 'SoFi Stadium - US Opener', path: '/world-cup-2026-host-cities/los-angeles-city-guide', icon: MapPin },
  { id: 'c3', type: 'city', title: 'Mexico City', description: 'Estadio Azteca - Opening Match', path: '/world-cup-2026-host-cities/mexico-city-city-guide', icon: MapPin },
  { id: 'c4', type: 'city', title: 'Toronto', description: 'BMO Field - Canada Opener', path: '/world-cup-2026-host-cities/toronto-city-guide', icon: MapPin },
  { id: 'c5', type: 'city', title: 'Vancouver', description: 'BC Place', path: '/world-cup-2026-host-cities/vancouver-city-guide', icon: MapPin },
  { id: 'c6', type: 'city', title: 'Miami', description: 'Hard Rock Stadium', path: '/world-cup-2026-host-cities/miami-city-guide', icon: MapPin },
  { id: 'c7', type: 'city', title: 'Dallas', description: 'AT&T Stadium', path: '/world-cup-2026-host-cities/dallas-city-guide', icon: MapPin },
  { id: 'c8', type: 'city', title: 'Atlanta', description: 'Mercedes-Benz Stadium', path: '/world-cup-2026-host-cities/atlanta-city-guide', icon: MapPin },
  { id: 'c9', type: 'city', title: 'Boston', description: 'Gillette Stadium', path: '/world-cup-2026-host-cities/boston-city-guide', icon: MapPin },
  { id: 'c10', type: 'city', title: 'Guadalajara', description: 'Estadio Akron', path: '/world-cup-2026-host-cities/guadalajara-city-guide', icon: MapPin },
  { id: 'c11', type: 'city', title: 'Houston', description: 'NRG Stadium', path: '/world-cup-2026-host-cities/houston-city-guide', icon: MapPin },
  { id: 'c12', type: 'city', title: 'Kansas City', description: 'Arrowhead Stadium', path: '/world-cup-2026-host-cities/kansas-city-city-guide', icon: MapPin },
  { id: 'c13', type: 'city', title: 'Monterrey', description: 'Estadio BBVA', path: '/world-cup-2026-host-cities/monterrey-city-guide', icon: MapPin },
  { id: 'c14', type: 'city', title: 'Philadelphia', description: 'Lincoln Financial Field', path: '/world-cup-2026-host-cities/philadelphia-city-guide', icon: MapPin },
  { id: 'c15', type: 'city', title: 'San Francisco', description: "Levi's Stadium", path: '/world-cup-2026-host-cities/san-francisco-city-guide', icon: MapPin },
  { id: 'c16', type: 'city', title: 'Seattle', description: 'Lumen Field', path: '/world-cup-2026-host-cities/seattle-city-guide', icon: MapPin },
