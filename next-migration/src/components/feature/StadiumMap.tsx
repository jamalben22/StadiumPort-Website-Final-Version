...
import { WORLD_CUP_STADIUMS, Stadium } from '@/data/stadiums';
import { MapPin, X, Users, Trophy, ChevronRight } from 'lucide-react';
...
export function StadiumMap() {
  ...
  const [popupInfo, setPopupInfo] = useState<Stadium | null>(null);
            ...
            <div className="relative group cursor-pointer">
              ...
              <div 
                className={`marker-pulse w-4 h-4 rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ${
                  stadium.country === 'USA' ? 'bg-blue-500' : 
                  stadium.country === 'Canada' ? 'bg-red-500' : 'bg-emerald-500'
                }`} 
              />
              ...
              <div className={`relative z-10 flex flex-col items-center transition-transform duration-300 group-hover:scale-125`}>
                <div 
                  className={`w-6 h-6 rounded-full border-2 border-white dark:border-slate-900 shadow-lg flex items-center justify-center ${
                    stadium.country === 'USA' ? 'bg-blue-500 shadow-blue-500/30' : 
                    stadium.country === 'Canada' ? 'bg-red-500 shadow-red-500/30' : 'bg-emerald-500 shadow-emerald-500/30'
                  }`}
                >
        ...
        {popupInfo && (
          ...
          >
            ...
            >
              ...
              {/* CTA Button */}
              <Link 
                href={`/stadium-guide/${popupInfo.id}`}
          ...
          >
            ...
            <div className="p-5 pb-8 space-y-6">
              ...
              <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-2xl border border-slate-100 dark:border-white/5">
                <h4 className="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-3">Highlights</h4>
              ...
              <Link 
                ...
                className="block w-full"
              >
                <button className="w-full py-4 bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-slate-900 dark:text-white font-bold rounded-2xl shadow-lg shadow-blue-500/25 transition-all flex items-center justify-center gap-2">
                  Read Full Guide
