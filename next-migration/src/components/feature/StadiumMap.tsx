          ...
          >
            ...
            <div className="p-5 pb-8 space-y-6">
              ...
              <Link 
                ...
                className="block w-full"
              >
                <button className="w-full py-4 bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white font-bold rounded-2xl shadow-lg shadow-blue-500/25 transition-all flex items-center justify-center gap-2">
                  Read Full Guide
