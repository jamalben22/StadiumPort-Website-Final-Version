...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://stadiumport.com/world-cup-2026-family-safety-guide',
  },
  openGraph: {
    title: 'Family Safety Guide: Taking Kids to World Cup 2026',
    ...
    images: [
      {
        url: '/images/safety-guide/A_realistic_high-detail_photo_of_a_family_with_children_entering_or_walking_near_stadium.webp',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: 'Family Safety Guide: Taking Kids to World Cup 2026',
    description: 'Complete parent\'s guide to World Cup 2026 safety. Stadium strategies for kids, family lodging, transport tips, and emergency preparedness.',
    images: ['/images/safety-guide/A_realistic_high-detail_photo_of_a_family_with_children_entering_or_walking_near_stadium.webp'],
  },
