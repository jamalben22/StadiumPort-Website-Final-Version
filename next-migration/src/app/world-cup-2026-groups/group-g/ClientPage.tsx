            ...
            <aside className="hidden lg:block lg:col-span-3 relative">
              <div className="sticky top-32">
                ...
                <div className="mt-12 p-6 rounded-2xl border border-slate-100 dark:border-white/5">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mb-4 leading-relaxed">Get our free checklist for Group G travel.</p>
                  <AffiliateButton 
                    href="/planner" 
                    text="Start Planner" 
                    variant="secondary"
              ...
              <div className="relative overflow-hidden rounded-[3rem] text-white p-12 md:p-20 text-center shadow-2xl shadow-slate-900/20">
                ...
                <div className="relative z-10 max-w-3xl mx-auto">
                  ...
                  <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <Link href="/planner" className="inline-flex items-center justify-center text-slate-900 font-bold py-4 px-8 rounded-2xl transition-all hover:scale-105 text-base">
                      Start My Trip Plan
                    </Link>
                  </div>
                </div>
