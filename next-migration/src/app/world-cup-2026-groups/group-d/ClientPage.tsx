...
export default function GroupDClientPage() {
 ...
 <Link href="/planner" className="inline-flex items-center justify-center h-14 px-8 rounded-full bg-amber-500 hover:bg-amber-400 text-white font-bold text-sm tracking-wide transition-all shadow-xl shadow-amber-500/20">
 Get Free Checklist
 </Link>
