            ...
            <aside className="hidden lg:block lg:col-span-3 relative">
              <div className="sticky top-32">
                ...
                <div className="mt-12 p-6 rounded-2xl border border-slate-100 dark:border-white/5">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mb-4 leading-relaxed">Get our free checklist for Group F travel.</p>
                  <AffiliateButton 
                    href="/planner" 
                    text="Start Planner" 
                    variant="secondary"
              ...
              <section id="packing" className="scroll-mt-32">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    ...
                    <div key={i} className="p-6 rounded-2xl border border-slate-100 dark:border-slate-800 text-center">
