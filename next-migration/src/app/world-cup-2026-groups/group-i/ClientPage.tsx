            ...
            <aside className="hidden lg:block lg:col-span-3 relative">
              <div className="sticky top-32">
                ...
                <div className="mt-12 p-6 rounded-2xl border border-slate-100 dark:border-white/5">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mb-4 leading-relaxed">Get our free checklist for Group I travel.</p>
                  <AffiliateButton 
                    href="/planner" 
                    text="Start Planner" 
                    variant="secondary"
            ...
            <div className="lg:col-span-9 space-y-24">
              ...
              <section id="visas" className="scroll-mt-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  ...
                  <div className="bg-emerald-600 rounded-[2rem] p-10 text-white shadow-xl shadow-emerald-900/20">
              ...
              <section id="insider" className="scroll-mt-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-10 rounded-[2.5rem] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800">
              ...
              <section id="packing" className="scroll-mt-32">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {[
                    ...
                    <div key={i} className="text-center p-6 rounded-3xl border border-slate-100 dark:border-slate-800">
