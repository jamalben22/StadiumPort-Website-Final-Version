            ...
            >
              <Breadcrumb 
                items={[
                  ...
                  { label: 'Weather Safety', href: '/guides/weather-climate-safety-world-cup-2026' }
                ]} 
                variant="light"
                className="mb-8"
              />
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-slate-900 dark:text-white tracking-tighter mb-6 leading-[0.9]">
                WEATHER & <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-500">CLIMATE SAFETY</span>
              </h1>
