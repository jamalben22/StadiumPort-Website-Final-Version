...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://stadiumport.com/guides/local-laws-cultural-etiquette-world-cup-2026',
  },
  openGraph: {
    title: 'Local Laws & Cultural Etiquette: World Cup 2026 Guide',
...
export default function LocalLawsPage() {
  const articleSchema = generateArticleSchema(
    ...
    '/guides/local-laws-cultural-etiquette-world-cup-2026'
  );
  
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'Safety Guide', item: '/world-cup-2026-safety-guide' },
    { name: 'Local Laws & Etiquette', item: '/guides/local-laws-cultural-etiquette-world-cup-2026' }
  ]);
