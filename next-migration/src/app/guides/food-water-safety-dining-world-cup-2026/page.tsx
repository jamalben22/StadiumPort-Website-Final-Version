...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://stadiumport.com/guides/food-water-safety-dining-world-cup-2026',
  },
  openGraph: {
    title: 'Food & Water Safety: Dining Without Distress',
    description: 'Expert guide to World Cup 2026 food & water safety. Learn where to eat, water potability in USA/Canada/Mexico, and how to avoid traveler\'s diarrhea.',
...
export default function FoodSafetyPage() {
  const articleSchema = generateArticleSchema('food-water-safety-dining-world-cup-2026', '/guides/food-water-safety-dining-world-cup-2026');
  
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'Guides', item: '/guides' },
    { name: 'Food & Water Safety', item: '/guides/food-water-safety-dining-world-cup-2026' }
  ]);
