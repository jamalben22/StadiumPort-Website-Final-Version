...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://stadiumport.com/guides/nightlife-after-hours-safety-world-cup-2026',
  },
  openGraph: {
    title: 'Nightlife & After-Hours Safety: World Cup 2026 Guide',
    description: 'Expert guide to World Cup 2026 nightlife safety. Enjoy the atmosphere responsibly with tips on safe transport, alcohol awareness, and venue security in USA, Canada & Mexico.',
...
export default function NightlifeSafetyPage() {
  const articleSchema = generateArticleSchema('nightlife-after-hours-safety-world-cup-2026', '/guides/nightlife-after-hours-safety-world-cup-2026');
  
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'Guides', item: '/guides' },
    { name: 'Nightlife Safety', item: '/guides/nightlife-after-hours-safety-world-cup-2026' }
  ]);
