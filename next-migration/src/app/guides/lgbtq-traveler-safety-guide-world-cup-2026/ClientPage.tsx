...
import { 
  Heart, Flag, Users, MapPin, Shield, Globe, Lock, UserCheck,
  Info, ChevronRight, ArrowRight, ShieldAlert, CheckCircle2,
...
const SocialShare = () => {
  ...
  const handleShare = (platform: string) => {
    ...
    const text = "LGBTQ+ Traveler Safety Guide: World Cup 2026";
    ...
    <section id={id} ref={ref} className={`py-16 md:py-24 scroll-mt-24 ${className}`}>
      ...
      >
        <h2 className="text-4xl md:text-6xl font-black text-slate-900 dark:text-white mb-12 tracking-tight">
          <span className="text-emerald-600 dark:text-emerald-500 text-lg md:text-xl font-bold uppercase tracking-widest block mb-2">Inclusive & Safe</span>
          {title}
        </h2>
        {children}
      </motion.div>
...
export default function ClientPage() {
  ...
  const navLinks = [
    ...
    { id: 'cities', label: 'City Guide' },
    { id: 'trans', label: 'Transgender Travel' },
    { id: 'dating', label: 'Dating Apps' },
    { id: 'faq', label: 'FAQ' },
  ];
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              >
                ...
                <span className="text-slate-500">/</span>
                <span className="text-emerald-400">LGBTQ+ Safety</span>
              </motion.div>
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-slate-900 dark:text-white tracking-tighter mb-6 leading-[0.9]">
                LGBTQ+ TRAVELER <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-500">SAFETY GUIDE</span>
              </h1>
              <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 font-light max-w-xl leading-relaxed">
                Navigating the World Cup 2026 with pride and peace of mind in USA, Canada, and Mexico.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <main className="flex-1 min-w-0 pb-24">
          ...
          <div className="mb-12 p-6 rounded-2xl text-sm text-slate-500 dark:text-slate-400 flex gap-4 items-start bg-slate-100 dark:bg-slate-50 dark:bg-slate-900/50">
            ...
            <p className="leading-relaxed">
              North America is generally very safe for LGBTQ+ travelers, but laws and attitudes can vary by region. This guide focuses on maximizing your safety and enjoyment.
            </p>
          </div>

          <Section id="rights" title="LEGAL RIGHTS OVERVIEW">
            <p className="text-xl text-slate-600 dark:text-slate-300 leading-relaxed mb-8 font-light">
               The legal landscape is robust across all three host nations.
            </p>

            <ComparisonTable 
              headers={["Right", "🇺🇸 USA", "🇨🇦 Canada", "🇲🇽 Mexico"]}
              rows={[
                ["Same-Sex Marriage", "Legal Nationwide", "Legal Nationwide", "Legal Nationwide"],
                ["Discrimination Laws", "Varies by State", "Strong Federal Protections", "Constitutionally Protected"],
                ["Gender Identity", "Varies by State", "Protected Nationwide", "Protected in most states"],
                ["Conversion Therapy", "Banned in 20+ states", "Banned Nationwide", "Banned Nationwide"]
              ]}
            />
          </Section>

          <Section id="cities" title="CITY SAFETY GUIDE">
             <div className="grid md:grid-cols-2 gap-8 mb-8">
               <GreenShieldBox 
                 title="Super Safe / Vibrant"
                 items={[
                   "Toronto & Vancouver (Canada): Extremely inclusive.",
                   "San Francisco (Bay Area): Historic LGBTQ+ hub.",
                   "New York / New Jersey: Very high acceptance.",
                   "Mexico City: Zona Rosa is world-famous."
                 ]}
               />
               <div className="p-8 rounded-[2rem] border border-orange-200 dark:border-orange-900/30 bg-orange-50/50 dark:bg-orange-900/10 mb-8">
                 <h4 className="font-bold text-2xl mb-6 text-orange-700 dark:text-orange-400 flex items-center gap-3">
                   <AlertTriangle className="w-8 h-8"/>
                   Exercise Caution
                 </h4>
                 <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                   While host cities like Dallas, Houston, and Kansas City have vibrant gay scenes (Oak Lawn in Dallas, Montrose in Houston), the surrounding rural areas and state politics can be more conservative. Public displays of affection outside of "gayborhoods" in these regions may attract stares.
                 </p>
               </div>
             </div>
          </Section>

          <Section id="trans" title="TRANSGENDER TRAVEL TIPS">
            <p className="text-xl text-slate-600 dark:text-slate-300 leading-relaxed mb-8 font-light">
               Traveling while trans can present unique challenges, particularly at borders and checkpoints.
            </p>
            ...
            <div className="bg-slate-50 dark:bg-slate-900/50 p-8 rounded-[2rem] border border-slate-200 dark:border-slate-800 mb-8">
               <h3 className="text-2xl font-bold mb-4 flex items-center gap-3 text-slate-900 dark:text-white">
                 <UserCheck className="w-8 h-8 text-emerald-500" /> TSA & Border Security
               </h3>
               <ul className="space-y-4 text-slate-600 dark:text-slate-400">
                 <li className="flex gap-3"><Check className="w-5 h-5 text-emerald-500 shrink-0" /> <strong>Identity Documents:</strong> It is best if your passport gender marker matches your presentation, though not always possible.</li>
                 <li className="flex gap-3"><Check className="w-5 h-5 text-emerald-500 shrink-0" /> <strong>Body Scanners:</strong> TSA scanners often flag "anomalies" based on binary gender selection by agents. You can request a private screening if preferred.</li>
                 <li className="flex gap-3"><Check className="w-5 h-5 text-emerald-500 shrink-0" /> <strong>Medication:</strong> Keep hormones/meds in original prescription bottles.</li>
               </ul>
            </div>
          </Section>

          <Section id="dating" title="DATING APPS SAFETY">
            <RedFlagBox 
              title="App Safety Warning"
              items={[
                "Be cautious of 'catfishing' or setups, especially in Mexico.",
                "Meet in public places first.",
                "Share your live location with a friend before meeting someone.",
          ...
          <Section id="faq" title="FREQUENTLY ASKED QUESTIONS">
            <div className="space-y-4">
              <FAQItem 
                question="Which bathrooms should I use?"
                answer="In Canada and many US states (CA, NY, WA), you have the legal right to use the bathroom corresponding to your gender identity. In some other US states, laws are in flux; family/unisex restrooms are the safest bet if unsure."
              />
              <FAQItem 
                question="Is Mexico City safe for gay couples?"
                answer="Yes, Mexico City is one of the most progressive cities in Latin America. The Zona Rosa district is the center of LGBTQ+ life. Same-sex marriage is legal and common."
              />
              <FAQItem 
                question="What if I encounter discrimination?"
                answer="FIFA has strict anti-discrimination policies in stadiums. Report incidents to stadium security immediately. Outside stadiums, laws vary, but violence is a crime everywhere—call 911 (USA/Canada/Mexico)."
              />
            </div>
          </Section>
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 dark:from-emerald-900 dark:to-slate-900 rounded-[3rem] p-12 text-center relative overflow-hidden mt-20">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-xl text-slate-300 mb-10 leading-relaxed">
                Enjoy the World Cup 2026 with the freedom to be yourself.
              </p>
