...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://stadiumport.com/guides/staying-connected-sim-cards-emergency-communications-world-cup-2026',
  },
  openGraph: {
    title: 'Staying Connected: SIM Cards & Emergency Comms 2026',
...
export default function ConnectivityPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Staying Connected', item: '/guides/staying-connected-sim-cards-emergency-communications-world-cup-2026' }
  ]);
