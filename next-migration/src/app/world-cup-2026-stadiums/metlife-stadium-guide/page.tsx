...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/images/stadiums/metlife-stadium-east-rutherford-world-cup-2026-1600.webp',
        width: 1600,
        height: 1066,
  ...
  twitter: {
    ...
    images: ['/images/stadiums/metlife-stadium-east-rutherford-world-cup-2026-1600.webp'],
  },
};
