...
export default function Page() {
  const jsonLd = generateArticleSchema('atlanta-city-guide', '/world-cup-2026-host-cities-guide/atlanta-city-guide');

  const breadcrumbLd = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'Host Cities', item: '/world-cup-2026-host-cities-guide' },
    { name: 'Atlanta Guide', item: '/world-cup-2026-host-cities-guide/atlanta-city-guide' }
  ]);
