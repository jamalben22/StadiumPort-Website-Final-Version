...
export const metadata: Metadata = {
 ...
 alternates: {
 canonical: '/world-cup-2026-host-cities-guide/toronto-city-guide',
 },
 openGraph: {
 title: 'Toronto World Cup 2026 Travel Guide: Hotels, Transport, Tickets',
...
export default function Page() {
  const jsonLd = generateArticleSchema('toronto-city-guide', '/world-cup-2026-host-cities-guide/toronto-city-guide');

  const breadcrumbLd = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'Host Cities', item: '/world-cup-2026-host-cities' },
    { name: 'Toronto Guide', item: '/world-cup-2026-host-cities-guide/toronto-city-guide' }
  ]);
