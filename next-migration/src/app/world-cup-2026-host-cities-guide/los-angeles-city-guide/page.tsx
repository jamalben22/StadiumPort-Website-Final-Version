...
export default function Page() {
  const jsonLd = generateArticleSchema('los-angeles-city-guide', '/world-cup-2026-host-cities-guide/los-angeles-city-guide');

  const breadcrumbLd = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'Host Cities', item: '/world-cup-2026-host-cities-guide' },
    { name: 'Los Angeles Guide', item: '/world-cup-2026-host-cities-guide/los-angeles-city-guide' }
  ]);
