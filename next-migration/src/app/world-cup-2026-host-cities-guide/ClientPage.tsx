...
const cities = [
 // USA
 { name: 'Atlanta', country: 'USA', flag: '🇺🇸', stadium: 'Mercedes-Benz Stadium', image: '/images/cities/atlanta-world-cup-2026-1024.webp', highlights: ['Modern retractable roof stadium', 'Civil rights history', 'Busy international airport'], link: '/world-cup-2026-host-cities-guide/atlanta-city-guide', region: 'East' },
 { name: 'Boston', country: 'USA', flag: '🇺🇸', stadium: 'Gillette Stadium', image: '/images/cities/boston-world-cup-2026-1024.webp', highlights: ['Historic American city', 'Passionate sports culture', 'Seafood and harbor'], link: '/world-cup-2026-host-cities-guide/boston-city-guide', region: 'East' },
 { name: 'Dallas', country: 'USA', flag: '🇺🇸', stadium: 'AT&T Stadium', image: '/images/cities/dallas-world-cup-2026-1024.webp', highlights: ['Massive stadium capacity', 'Central location', 'Texas BBQ'], link: '/world-cup-2026-host-cities-guide/dallas-city-guide', region: 'Central' },
 { name: 'Houston', country: 'USA', flag: '🇺🇸', stadium: 'NRG Stadium', image: '/images/cities/houston-world-cup-2026-1024.webp', highlights: ['Space City attractions', 'Diverse culinary scene', 'Climate-controlled stadium'], link: '/world-cup-2026-host-cities-guide/houston-city-guide', region: 'Central' },
 { name: 'Kansas City', country: 'USA', flag: '🇺🇸', stadium: 'Arrowhead Stadium', image: '/images/cities/kansas-city-world-cup-2026-1024.webp', highlights: ['Loudest stadium in the world', 'Famous BBQ', 'Heart of America'], link: '/world-cup-2026-host-cities-guide/kansas-city-city-guide', region: 'Central' },
 { name: 'Los Angeles', country: 'USA', flag: '🇺🇸', stadium: 'SoFi Stadium', image: '/images/cities/los-angeles-world-cup-2026-1024.webp', highlights: ['Entertainment capital', 'State-of-the-art stadium', 'Beaches and glamour'], link: '/world-cup-2026-host-cities-guide/los-angeles-city-guide', region: 'West' },
 { name: 'Miami', country: 'USA', flag: '🇺🇸', stadium: 'Hard Rock Stadium', image: '/images/cities/miami-world-cup-2026-1024.webp', highlights: ['Vibrant nightlife', 'Latin American influence', 'Art Deco district'], link: '/world-cup-2026-host-cities-guide/miami-city-guide', region: 'East' },
 { name: 'New York/New Jersey', country: 'USA', flag: '🇺🇸', stadium: 'MetLife Stadium', image: '/images/cities/new-york-new-jersey-world-cup-2026-1024.webp', highlights: ['Hosting the Final', 'Global cultural hub', 'Iconic skyline'], link: '/world-cup-2026-host-cities-guide/new-york-city-guide', region: 'East' },
 { name: 'Philadelphia', country: 'USA', flag: '🇺🇸', stadium: 'Lincoln Financial Field', image: '/images/cities/philadelphia-world-cup-2026-1024.webp', highlights: ['Birthplace of America', 'Passionate fans', 'Historic landmarks'], link: '/world-cup-2026-host-cities-guide/philadelphia-city-guide', region: 'East' },
 { name: 'San Francisco Bay Area', country: 'USA', flag: '🇺🇸', stadium: "Levi's Stadium", image: '/images/cities/san-francisco-world-cup-2026-1024.webp', highlights: ['Tech hub proximity', 'Golden Gate Bridge', 'Wine country nearby'], link: '/world-cup-2026-host-cities-guide/san-francisco-city-guide', region: 'West' },
 { name: 'Seattle', country: 'USA', flag: '🇺🇸', stadium: 'Lumen Field', image: '/images/cities/seattle-world-cup-2026-1024.webp', highlights: ['Scenic waterfront', 'Coffee culture', 'Loud stadium atmosphere'], link: '/world-cup-2026-host-cities-guide/seattle-city-guide', region: 'West' },
 // Canada
 { name: 'Toronto', country: 'Canada', flag: '🇨🇦', stadium: 'BMO Field', image: '/images/cities/toronto-world-cup-2026-1024.webp', highlights: ['BMO Field', 'CN Tower', 'Multicultural Food'], link: '/world-cup-2026-host-cities-guide/toronto-city-guide', region: 'East' },
 { name: 'Vancouver', country: 'Canada', flag: '🇨🇦', stadium: 'BC Place', image: '/images/cities/vancouver-world-cup-2026-1024.webp', highlights: ['BC Place', 'Stanley Park', 'Mountains & Ocean'], link: '/world-cup-2026-host-cities-guide/vancouver-city-guide', region: 'West' },
 // Mexico
 { name: 'Mexico City', country: 'Mexico', flag: '🇲🇽', stadium: 'Estadio Azteca', image: '/images/cities/mexico-city-world-cup-2026-1024.webp', highlights: ['Estadio Azteca', 'Tacos', 'Aztec History'], link: '/world-cup-2026-host-cities-guide/mexico-city-city-guide', region: 'Central' },
 { name: 'Guadalajara', country: 'Mexico', flag: '🇲🇽', stadium: 'Estadio Akron', image: '/images/cities/guadalajara-world-cup-2026-1024.webp', highlights: ['Home of Mariachi', 'Historic architecture', 'Passionate soccer culture'], link: '/world-cup-2026-host-cities-guide/guadalajara-city-guide', region: 'Central' },
 { name: 'Monterrey', country: 'Mexico', flag: '🇲🇽', stadium: 'Estadio BBVA', image: '/images/cities/monterrey-world-cup-2026-1024.webp', highlights: ['Modern industrial city', 'Stunning mountain views', 'Modern stadium'], link: '/world-cup-2026-host-cities-guide/monterrey-city-guide', region: 'Central' },
];
