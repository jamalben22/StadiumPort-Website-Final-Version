...
export const metadata: Metadata = {
 ...
 alternates: {
 canonical: '/world-cup-2026-host-cities/miami-city-guide',
 },
 openGraph: {
 title: 'Miami World Cup 2026 Guide: Hard Rock Stadium & Travel Tips',
 description: 'The ultimate guide to Miami for World Cup 2026. Navigate Hard Rock Stadium transport, find the best hotels in South Beach, and explore Wynwood and Little Havana.',
 url: 'https://stadiumport.com/world-cup-2026-host-cities/miami-city-guide',
 siteName: 'Stadiumport',
 locale: 'en_US',
 type: 'article',
 images: [
 {
 url: 'https://stadiumport.com/images/cities/miami-world-cup-2026.webp',
 width: 1200,
 height: 630,
 ...
 title: 'Miami World Cup 2026 Guide: Hard Rock Stadium & Travel Tips',
 description: 'The ultimate guide to Miami for World Cup 2026. Navigate Hard Rock Stadium transport, find the best hotels in South Beach, and explore Wynwood and Little Havana.',
 images: ['https://stadiumport.com/images/cities/miami-world-cup-2026.webp'],
 },
};

export default function Page() {
  const jsonLd = generateArticleSchema('miami-city-guide', '/world-cup-2026-host-cities/miami-city-guide');

  const breadcrumbLd = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'Host Cities', item: '/world-cup-2026-host-cities' },
    { name: 'Miami City Guide', item: '/world-cup-2026-host-cities/miami-city-guide' }
  ]);
