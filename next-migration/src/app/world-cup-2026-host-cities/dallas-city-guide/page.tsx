...
export const metadata: Metadata = {
 ...
 alternates: {
 canonical: '/world-cup-2026-host-cities/dallas-city-guide',
 },
 openGraph: {
 title: 'Dallas World Cup 2026 Guide: AT&T Stadium & Travel Tips',
 description: 'The ultimate guide to Dallas & Arlington for World Cup 2026. Navigate AT&T Stadium transport, find the best BBQ, and book hotels in Uptown or Fort Worth.',
 url: 'https://stadiumport.com/world-cup-2026-host-cities/dallas-city-guide',
 siteName: 'Stadiumport',
 locale: 'en_US',
 type: 'article',
 images: [
 {
 url: 'https://stadiumport.com/images/cities/dallas-world-cup-2026.webp',
 width: 1200,
 height: 630,
 ...
 title: 'Dallas World Cup 2026 Guide: AT&T Stadium & Travel Tips',
 description: 'The ultimate guide to Dallas & Arlington for World Cup 2026. Navigate AT&T Stadium transport, find the best BBQ, and book hotels in Uptown or Fort Worth.',
 images: ['https://stadiumport.com/images/cities/dallas-world-cup-2026.webp'],
 },
};

export default function Page() {
  const jsonLd = generateArticleSchema('dallas-city-guide', '/world-cup-2026-host-cities/dallas-city-guide');

  const breadcrumbLd = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'Host Cities', item: '/world-cup-2026-host-cities' },
    { name: 'Dallas Guide', item: '/world-cup-2026-host-cities/dallas-city-guide' }
  ]);
