...
export const metadata: Metadata = {
 ...
 alternates: {
 canonical: '/world-cup-2026-host-cities/seattle-city-guide',
 },
 openGraph: {
 title: 'Seattle World Cup 2026 Travel Guide: Hotels, Transport, Tickets',
 ...
 url: 'https://stadiumport.com/world-cup-2026-host-cities/seattle-city-guide',
 siteName: 'Stadiumport',
 locale: 'en_US',
 type: 'article',
 images: [
 {
 url: 'https://stadiumport.com/images/seattle-hero.jpg',
 width: 1200,
 height: 630,
...
export default function Page() {
  const jsonLd = generateArticleSchema('seattle-city-guide', '/world-cup-2026-host-cities/seattle-city-guide');

  const breadcrumbLd = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'Host Cities', item: '/world-cup-2026-host-cities' },
    { name: 'Seattle Guide', item: '/world-cup-2026-host-cities/seattle-city-guide' }
  ]);
