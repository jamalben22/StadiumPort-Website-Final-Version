...
export const metadata: Metadata = {
 ...
 description: 'Plan World Cup 2026 in Toronto: BMO Field tips, best downtown/Liberty Village hotels, UP Express/TTC strategy from YYZ airport, dining near King West, safety, packing, and insider advice.',
 alternates: {
 canonical: '/world-cup-2026-host-cities/toronto-city-guide',
 },
 openGraph: {
 title: 'Toronto World Cup 2026 Travel Guide: Hotels, Transport, Tickets',
 ...
 url: 'https://stadiumport.com/world-cup-2026-host-cities/toronto-city-guide',
 siteName: 'Stadiumport',
 locale: 'en_US',
 type: 'article',
 images: [
 {
 url: 'https://stadiumport.com/images/cities/toronto-world-cup-2026.webp',
 width: 1200,
 height: 630,
...
export default function Page() {
  const jsonLd = generateArticleSchema('toronto-city-guide', '/world-cup-2026-host-cities/toronto-city-guide');

  const breadcrumbLd = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'Host Cities', item: '/world-cup-2026-host-cities' },
    { name: 'Toronto Guide', item: '/world-cup-2026-host-cities/toronto-city-guide' }
  ]);
