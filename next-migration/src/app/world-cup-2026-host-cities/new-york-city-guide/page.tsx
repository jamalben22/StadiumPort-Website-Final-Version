...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/world-cup-2026-host-cities/new-york-city-guide',
  },
  openGraph: {
    title: 'New York/NJ World Cup 2026 Travel Guide: Hotels, Transport, Tickets',
    ...
    url: 'https://stadiumport.com/world-cup-2026-host-cities/new-york-city-guide',
    siteName: 'Stadiumport',
    locale: 'en_US',
    type: 'article',
    images: [
      {
        url: 'https://stadiumport.com/images/cities/new-york-new-jersey-world-cup-2026.webp',
        width: 1200,
        height: 630,
...
export default function Page() {
  const jsonLd = generateArticleSchema('new-york-city-guide', '/world-cup-2026-host-cities/new-york-city-guide');

  const breadcrumbLd = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'Host Cities', item: '/world-cup-2026-host-cities' },
    { name: 'New York City Guide', item: '/world-cup-2026-host-cities/new-york-city-guide' }
  ]);
