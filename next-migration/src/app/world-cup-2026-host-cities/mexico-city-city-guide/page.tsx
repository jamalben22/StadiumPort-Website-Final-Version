...
export const metadata: Metadata = {
 ...
 alternates: {
 canonical: '/world-cup-2026-host-cities/mexico-city-city-guide',
 },
 openGraph: {
 title: 'Mexico City World Cup 2026 Guide: Matches, Hotels & Travel',
 description: 'Complete Mexico City World Cup 2026 guide: match schedule, best hotels, transportation, things to do, and insider tips for the ultimate fan experience.',
 url: 'https://stadiumport.com/world-cup-2026-host-cities/mexico-city-city-guide',
 type: 'article',
 images: [
 {
 url: 'https://stadiumport.com/images/cities/mexico-city-world-cup-2026.webp',
 width: 1200,
 height: 630,
...
export default function MexicoCityGuide() {
  const jsonLd = generateArticleSchema('mexico-city-city-guide', '/world-cup-2026-host-cities/mexico-city-city-guide');

  const breadcrumbLd = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'World Cup 2026 Host Cities', item: '/world-cup-2026-host-cities' },
    { name: 'Mexico City Guide', item: '/world-cup-2026-host-cities/mexico-city-city-guide' }
  ]);
 ...
 image: [
 'https://stadiumport.com/images/cities/mexico-city-world-cup-2026.webp'
 ],
