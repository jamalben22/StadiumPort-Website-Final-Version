...
export const metadata: Metadata = {
 ...
 title: 'Guadalajara World Cup 2026 City Guide | Stadiumport',
 description: 'The ultimate guide to World Cup 2026 in Guadalajara. Stadium info, transport tips, where to stay, and the best tequila and mariachi experiences.',
 url: 'https://stadiumport.com/world-cup-2026-host-cities/guadalajara-city-guide',
 siteName: 'Stadiumport',
 images: [
 {
 url: 'https://stadiumport.com/images/cities/guadalajara-world-cup-2026.webp',
 width: 1200,
 height: 630,
 ...
 title: 'Guadalajara World Cup 2026 City Guide | Stadiumport',
 description: 'The ultimate guide to World Cup 2026 in Guadalajara. Stadium info, transport tips, where to stay, and the best tequila and mariachi experiences.',
 images: ['https://stadiumport.com/images/cities/guadalajara-world-cup-2026.webp'],
 },
 alternates: {
 canonical: 'https://stadiumport.com/world-cup-2026-host-cities/guadalajara-city-guide',
 },
};
...
export default function GuadalajaraCityGuide() {
  const jsonLd = generateArticleSchema('guadalajara-city-guide', '/world-cup-2026-host-cities/guadalajara-city-guide');

  const breadcrumbLd = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'World Cup 2026 Host Cities', item: '/world-cup-2026-host-cities' },
    { name: 'Guadalajara City Guide', item: '/world-cup-2026-host-cities/guadalajara-city-guide' }
  ]);
