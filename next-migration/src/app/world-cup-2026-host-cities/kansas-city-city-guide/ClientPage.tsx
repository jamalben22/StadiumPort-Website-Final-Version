...
import { 
 ...
 Train, Car, Briefcase,
 Bookmark, X, ChevronRight, Facebook, Twitter, Linkedin, AlertTriangle
} from 'lucide-react';
...
export default function ClientPage() {
 ...
 <div className="relative h-[65vh] min-h-[600px] w-full overflow-hidden flex items-center justify-center">
  <div className="absolute inset-0 z-0">
   <Image 
    src="https://stadiumport.com/images/cities/kansas-city-world-cup-2026-1600.webp" 
 ...
 <LightboxImage 
 src="https://stadiumport.com/images/stadiums/arrowhead-stadium-kansas-city-world-cup-2026.webp" 
 ...
 image="https://stadiumport.com/images/cities/kansas-city-world-cup-2026.webp" 
 link="#"
 />
 <HotelCard 
 ...
 <div className="mt-8">
 <AffiliateButton href="#" text="View All Attractions" variant="primary" />
 </div>
 </Section>
