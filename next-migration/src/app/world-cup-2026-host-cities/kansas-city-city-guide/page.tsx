...
export const metadata: Metadata = {
 ...
 alternates: {
 canonical: '/world-cup-2026-host-cities/kansas-city-city-guide',
 },
 openGraph: {
 ...
 url: 'https://stadiumport.com/world-cup-2026-host-cities/kansas-city-city-guide',
 siteName: 'Stadiumport',
 locale: 'en_US',
 type: 'article',
 images: [
 {
 url: 'https://stadiumport.com/images/cities/kansas-city-world-cup-2026.webp',
 width: 1200,
 height: 630,
...
export default function Page() {
  const jsonLd = generateArticleSchema('kansas-city-city-guide', '/world-cup-2026-host-cities/kansas-city-city-guide');

  const breadcrumbLd = generateBreadcrumbSchema([
    { name: 'Home', item: '/' },
    { name: 'Host Cities', item: '/world-cup-2026-host-cities' },
    { name: 'Kansas City Guide', item: '/world-cup-2026-host-cities/kansas-city-city-guide' }
  ]);
